...
//        if (userDto.getRole() != null && !userDto.getRole().isBlank() && !isValidRole(userDto.getRole())) {
//            return ResponseEntity.badRequest().body(new APIResponse<>(HttpStatus.BAD_REQUEST.value(), "Invalid role specified"));
//        }
